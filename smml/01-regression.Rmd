...
The outcome all these steps is something that seems relatively simple, that the estimate of the intercept is just based on the estimated slope and the average 
