...
## sECTION 3 - Data Importing/Cleaning
...
- But what about when you have to use 3rd party data, e.g., weather information
    ...
    - Then you have to clean and tidy the data
- Dataset formats
...
- Download the citibike_data directory from the same site where you folder where you downloaded the R file
...
```{r}
read_csv('E:/GitHub/Presentations/RBootcamp/citibike_data/201701-citibike-tripdata.csv')
```
...
read_csv('E:/GitHub/Presentations/RBootcamp/citibike_data/201701-citibike-tripdata.csv',col_names = column_names)
```
...
```{r}
citi_bike <- read_csv('E:/GitHub/Presentations/RBootcamp/citibike_data/201701-citibike-tripdata.csv',col_names = column_names, skip=1)
citi_bike
```
